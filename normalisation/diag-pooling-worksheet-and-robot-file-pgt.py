...
#  * Equimolar pooling of PGT libraries

# It's the same script as the normal pooling script. The lab want a separate version series for the
# PGT pooling step so this script is used instead to avoid any unintended modifications.
